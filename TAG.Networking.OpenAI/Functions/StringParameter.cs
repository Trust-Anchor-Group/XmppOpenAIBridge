...
namespace TAG.Networking.OpenAI.Functions
{
	...
	public class StringParameter : Parameter
	{
		...
		public StringParameter(string Name, string Description, bool Required)
			: this(Name, Description, Required, null, null, null, null)
		{
		}
		...
		public StringParameter(string Name, string Description, bool Required, int? MinLength, int? MaxLength)
			: this(Name, Description, Required, MinLength, MaxLength, null, null)
		{
		}
		...
		public StringParameter(string Name, string Description, bool Required, string Pattern)
			: this(Name, Description, Required, null, null, Pattern, null)
		{
		}
		...
		public StringParameter(string Name, string Description, bool Required, StringParameterFormat? Format)
			: this(Name, Description, Required, null, null, null, Format)
		{
		}
		...
		/// <param name="Format">String parameter format.</param>
		public StringParameter(string Name, string Description, bool Required, int? MinLength, int? MaxLength, 
			string Pattern, StringParameterFormat? Format)
