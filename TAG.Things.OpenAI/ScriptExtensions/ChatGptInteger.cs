...
{
	/// <summary>
	/// Creates a Integer parameter for a ChatGPT function definition.
	/// </summary>
	public class ChatGptInteger : FunctionMultiVariate
	{
		/// <summary>
		/// Creates a Integer parameter for a ChatGPT function definition.
		/// </summary>
		...
		public ChatGptInteger(ScriptNode Name, ScriptNode Description, ScriptNode Required, ScriptNode MultipleOf,
		...
		/// <param name="Length">Length of expression covered by node.</param>
		/// <param name="Expression">Expression containing script.</param>
		public ChatGptInteger(ScriptNode Name, ScriptNode Description, ScriptNode Required,
			ScriptNode MinValue, ScriptNode MinValidIncluded, ScriptNode MaxValue, ScriptNode MaxValidIncluded, int Start, int Length, Expression Expression)
		...
		/// </summary>
		public override string FunctionName => nameof(ChatGptInteger);
		...
		public override IElement Evaluate(IElement[] Arguments, Variables Variables)
		{
			...
			return new ObjectValue(new IntegerParameter(Name, Description, Required, MinValue, MinValueIncluded, MaxValue, MaxValueIncluded, MultipleOf));
		}
